...
* The original package name 'com.epam.brest.spring-security-with-dynamic auth' is invalid and this project uses 'com.epam.brest.springsecuritywithdynamic.auth' instead.
